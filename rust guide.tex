...
\begin{itemize}
  ...
  \item Rust has a offical and very opiniated linter - it should always be used.
  \item Unfortunately Rust does not support default values for parameters or methods with the same name.
...
\begin{tabular}{ |c|p{12cm}| } 
 ...
 PartialEq & Implements basic equality checking and enables use of the == and != operators on the \lstinline[language=Rust]|struct| \\
 PartialOrd & Implements basic comparison and enables use of the > and < operators on the \lstinline[language=Rust]|struct| \\
