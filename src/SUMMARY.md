...
- [Types and variables](./types.md)
  ...
  - [Strings](./types_strings.md)
  - [Common types](./types_commmon.md)
  - [Constants](./types_constants.md)
...
- [Methods](./methods.md)
  - [this/self](./methods_self.md)
  - [Functional Programming](./methods_functional.md)

- [Modules](./modules.md)
  - [Directories](./modules_directories.md)

- [Crates](./crates.md)
  - [Adding crates](./crates_adding.md)
  - [Not in standard](./crates_standard.md)
